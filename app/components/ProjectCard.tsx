...
export default function ProjectCard({ project, variant = "default" }: ProjectCardProps) {
      ...
      >
        <div className="relative h-44 overflow-hidden">
          ...
          <div className="absolute bottom-0 left-0 right-0 p-4">
            <h3 className="font-bold text-white mb-1.5 line-clamp-2 text-sm drop-shadow-lg">
              {project.title}
            </h3>
          </div>
        </div>
  ...
  return (
    ...
    >
      ...
      <div className="p-5">
        <h3 className="text-base font-bold text-gray-900 dark:text-white mb-2 transition-colors line-clamp-2 leading-snug">
          {project.title}
        </h3>
